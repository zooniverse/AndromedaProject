...
(function() {
  ...
  define(function(require, exports, module) {
    ...
    Tutorial = (function() {
      ...
      Tutorial.prototype.end = function() {
        ...
        if ((_ref = User.current) != null) {
          _ref.setFinishedTutorial(true);
        }
        if ((_ref1 = this.steps[this.current]) != null) {
          _ref1.leave();
        }
    ...
    Tutorial.Step = (function() {
      ...
      function Step(_arg) {
        var line, _base, _base1, _base2, _base3, _base4, _base5, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
        this.heading = _arg.heading, this.content = _arg.content, this.style = _arg.style, this.attach = _arg.attach, this.block = _arg.block, this.nextOn = _arg.nextOn, this.continueText = _arg.continueText, this.className = _arg.className, this.arrowClass = _arg.arrowClass;
        ...
        if ((_ref7 = this.continueText) == null) {
