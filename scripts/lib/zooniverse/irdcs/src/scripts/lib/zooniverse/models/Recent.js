...
(function() {
  ...
  define(function(require, exports, module) {
    ...
    Recent = (function(_super) {
      ...
      Recent.configure('Recent', 'createdAt', 'subjects');

      Recent.fromJSON = function(raw) {
      ...
      Recent.prototype.toJSON = function() {
        var subject;
        return {
          recent: {
