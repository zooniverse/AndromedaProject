define (require, exports, module) ->
  ...
  module.exports = [
    ...
    new Step
      ...
      onEnter: ->
        jQuery('#classifier .selection-area img').attr('src', 'http://www.andromedaproject.org/subjects/standard/F475W/tutorial.jpg')
      style: width: 400
      continueText: 'Next'
    ...
    new Step
      ...
      onEnter: ->
        ...
        jQuery("#classifier .selection-area img").attr("src", "http://www.andromedaproject.org/subjects/standard/color/tutorial_chipgap.jpeg")
      style: width: 400
      continueText: 'Next'
